...
--
-- Table structure for table `listing_media_immo`
--
...
--
-- Dumping data for table `listing_media_immo`
--

LOCK TABLES `listing_media_immo` WRITE;
/*!40000 ALTER TABLE `listing_media_immo` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `listing_media_immo` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `listings_immo`
--
...
--
-- Dumping data for table `listings_immo`
--

LOCK TABLES `listings_immo` WRITE;
/*!40000 ALTER TABLE `listings_immo` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `listings_immo` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `localities_immo`
--
...
--
-- Dumping data for table `localities_immo`
--

LOCK TABLES `localities_immo` WRITE;
/*!40000 ALTER TABLE `localities_immo` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `localities_immo` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `users_immo`
--
...
--
-- Dumping data for table `users_immo`
--

LOCK TABLES `users_immo` WRITE;
/*!40000 ALTER TABLE `users_immo` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `users_immo` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-07-24 18:32:50
