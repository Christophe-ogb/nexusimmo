...
--
-- Host: localhost    Database: nexus_immo
-- ------------------------------------------------------
...
CREATE TABLE `listings` (
  ...
  CONSTRAINT `fk_listings_locality` FOREIGN KEY (`locality_id`) REFERENCES `localities` (`id`),
...
INSERT INTO `listings` VALUES (2,5,1,'location','maison','Chambre Salon Sanitaire','Disponible à Fidjrosse Sinoutin une 02 chambres salon sanitaire au premier étage avec 02 douches, compteur personnel à carte, deuxième position des pavés,seul au premier \r\n \r\nLoyer 70mil\r\n \r\nConditions :\r\n03 mois d\'avance \r\n03 mois de loyers prépayé \r\nCaution eau électricité 30.000 FCFA \r\nCommission',70000.00,NULL,'+2290150387418','+2290150387418','active',0,2,NULL,NULL,'2026-07-24 15:18:35','2026-07-24 17:45:48');
...
INSERT INTO `localities` VALUES (1,'Cotonou','2026-07-19 10:27:12'),(2,'Abomey-Calavi','2026-07-19 10:27:12'),(3,'Porto-Novo','2026-07-19 10:27:12'),(4,'Parakou','2026-07-19 10:27:12'),(5,'Ouidah','2026-07-19 10:27:12');
...
-- Dump completed on 2026-07-24 18:32:33
